...
//    String trainPath = "C:\\datasets\\preprocessed_train.arff";
//    String testPath = "C:\\datasets\\preprocessed_test.arff";


    public static void runWithoutCV() throws Exception {
        GeneralParameters.DATASET = "E:\\ereno dataset\\ereninho\\multiclass_train.arff";
//        GeneralParameters.DATASET = "E:\\ereno dataset\\ereninho\\uc04\\train.arff";
//        GeneralParameters.DATASET = "C:\\datasets\\preprocessed_train.arff";;
//        GeneralParameters.DATASET = "preprocessed_train.arff";;
        Instances train = Util.loadSingleFile(false);
        train.setClassIndex(train.numAttributes() - 1);

        GeneralParameters.DATASET = "E:\\ereno dataset\\ereninho\\multiclass_test.arff";
//        GeneralParameters.DATASET = "C:\\datasets\\preprocessed_test.arff";
//        GeneralParameters.DATASET = "preprocessed_test.arff";
        Instances test = Util.loadSingleFile(false);
        test.setClassIndex(test.numAttributes() - 1);

        GeneralParameters.SINGLE_CLASSIFIER_MODE = GenericClassifiers.J48;
//        GenericResultado resultados = GenericEvaluation.testaEssaGalera(GenericClassifiers.KNN, train, test);
